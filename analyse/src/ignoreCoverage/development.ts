...
async function main() {
    ...
    path_to_project = "/Users/nbaumgartner/Documents/GitHub/Live-Code-Smell-Detection-of-Data-Clumps-in-an-Integrated-Development-Environment/Source Code/src/main/java/com/github/fiadleh/codesmellsplugin"
    let path_to_source_folder = path_to_project;
    let path_to_ast_output = "./../temp_ast_output";
    let commits_to_analyse: any[] = [];
    let check_needed = false;
